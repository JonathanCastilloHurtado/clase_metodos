...
public class Estudiante {
    ...
    public static void mostrarEstudianteEspecifico(Estudiante[] estudiantes, int numeroEstudiante) {
        if (numeroEstudiante >= 1 && numeroEstudiante <= estudiantes.length) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese el número del estudiante que desea ver (1 a 5):");
        int numeroEstudiante = scanner.nextInt();

        // Mostrar la información del estudiante específico
        mostrarEstudianteEspecifico(estudiantes, numeroEstudiante);
